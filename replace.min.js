var newD = 'allarknow.online', // новый домен
	oldD = ['alloeclub.com', 'allohalive.com', 'allohastream.com', 'thealloha.club', 'newplayjj.com', 'playjjnow.online', 'allarknow.online'], // список старых доменов + новый
	port = ':9443', // порт который должен быть указан у домена
	delay = 200;
replace();
function replace() {
